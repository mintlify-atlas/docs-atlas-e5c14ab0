---
title: "primemixxx: Open-Source MIXXX on Denon Prime Hardware"
...
primemixxx is built from five interlocking layers:
...
<CardGroup cols={2}>
  ...
  <Card title="Boot Chain" icon="sitemap" href="/architecture/boot-chain">
